...
public class Level_20_Data_Test_II_TestNG_XML extends BaseTest {
    ...
    @Parameters({"empFirstName", "empLastName", "empUserName", "empPassword", "empFullName", "statusValue"})
    @Test
    public void Employee_01_Add_New_Employee(String empFirstName, String empLastName, String empUserName, String empPassword, String empFullName, String statusValue) {
...
//        employeeListPage.waitForElementInvisible(driver, EmployeeListPageUI.LOADING_ICON);
    ...
    @Parameters({"editEmpFirstName", "editEmpLastName", "editEmpGender", "editEmpMaritalStatus", "editEmpNationality"})
    @Test
